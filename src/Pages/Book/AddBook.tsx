...
const AddBook = () => {
    ...
    return (
        <div className="mx-auto bg-white rounded-3xl shadow-md my-8 p-4 grid grid-cols-1 lg:grid-cols-2 gap-4">

            <div>
                <div>
                    <h1 className="text-blue-700 font-bold text-2xl text-center">Add Book</h1>
